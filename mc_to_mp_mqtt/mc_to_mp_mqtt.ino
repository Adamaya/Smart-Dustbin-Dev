...
void loop() {
  ...
  {
    client.publish("containerDataGreen", msg1);            // change container name according to dustbin // publishing message
    client.subscribe("containerDataGreen");                 // subscribing data
    delay(1000);
    client.loop();
  }
  for(int i=0;i<3;i++){
  ...
  {
    client.publish("containerDataBlue", msg2);           // change container name according to dustbin
    client.subscribe("containerDataBlue");
    delay(1000);
    client.loop();
  }
